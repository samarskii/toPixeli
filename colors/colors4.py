...
# winter_colors_4 WINTER 3660
# spring_colors_4 SPRING 3945
# happy_colors_4 HAPPY 4180
# nature_colors_4 NATURE 4660
# earth_colors_4 EARTH 4995
# night_colors_4 NIGHT 5200
...
winter_colors_4 = [
    ...
    ('#113F67', '#226597', '#87C0CD', '#F3F9FB'),
    ('#E3E7F1', '#C6CBEF', '#8186D5', '#494CA2'),
    ('#0A065D', '#A3816A', '#D2C8C8', '#F8F1F1'),
    ('#F0ECE2', '#ACDBDF', '#69779B', '#010101'),
    ('#1CB3C8', '#DFE2E2', '#738598', '#3C415E'),
    ('#FDB44B', '#448EF6', '#005792', '#00204A'),
    ('#B5525C', '#105E62', '#41AAA8', '#A2EAE2'),
    ('#0F0A3C', '#07456F', '#009F9D', '#CDFFEB'),
    ('#EEEEEE', '#B55400', '#393E46', '#222831'),
    ('#3161A3', '#13ABC4', '#7EFAFF', '#EBFFFB'),
    ('#D7EAEA', '#ACDBDF', '#9692AF', '#69779B'),
    ('#6E7DA2', '#DB996C', '#AEDADD', '#FCF8F3'),
    ('#CEDDEF', '#5893D4', '#1F3C88', '#070D59'),
    ...
    ('#E8FFC1', '#A5ECD7', '#51ADCF', '#0278AE'),
    ('#E7E7DE', '#008891', '#00587A', '#0F3057'),
    ('#F1D18A', '#73B1C1', '#588D9C', '#36626A'),
    ('#FF7F50', '#404969', '#BDE4F4', '#E0FCFF'),
    ('#E9D2B3', '#9BB4DA', '#1160AA', '#161D6E'),
    ('#0D1B4C', '#3F6699', '#78C2C3', '#F3ECC8'),
    ('#E3EFF3', '#CDE3EB', '#6E828A', '#143A52'),
    ('#430F58', '#6643B5', '#8594E4', '#D5DEF5'),
    ('#DC552C', '#404969', '#BDE4F4', '#F5FEFF'),
    ('#878ECD', '#B9BBDF', '#DDE7F2', '#DFF4F3'),
    ('#0245A3', '#8FBAF3', '#BDF1F6', '#F2FCFC'),
    ('#52524E', '#9A9B94', '#D4D6C8', '#E9E9E5'),
    ('#F8F8F8', '#5068A9', '#86A6DF', '#324E7B'),
    ('#EBF7FD', '#A5DEF1', '#36506C', '#233142'),
    ('#FFDED5', '#ACBDC5', '#52686A', '#314A52'),
    ('#390050', '#5A5D9D', '#6BC5D2', '#E1F5F2'),
    ('#F1F6F8', '#B9D4F1', '#21273D', '#6A759B'),
    ('#77ABB7', '#476D7C', '#254B62', '#1D3E53'),
    ('#0D3446', '#176D81', '#71ADB5', '#D8DFE2'),
    ('#D8D95C', '#5FBDC5', '#2866AB', '#073059'),
    ('#EDEDED', '#68868C', '#405559', '#3E3E3E'),
...
spring_colors_4 = [
    ...
    ('#B8B2A6', '#F4DADA', '#FDFDF6', '#DBE9B7'),
    ('#FFA1AC', '#FFE0A3', '#FFF6BE', '#B7FBFF'),
    ('#C5ECBE', '#FDFFDC', '#F781BC', '#F857B5'),
    ('#A23131', '#E8ECD6', '#FDFFF0', '#A1DD70'),
    ('#FB3569', '#FF9D76', '#FFFDE1', '#51EAEA'),
    ('#A4F6A5', '#F1EB9A', '#F8A978', '#F68787'),
    ('#3F8F8D', '#5DC0A6', '#F6B8D1', '#FFD3DE'),
    ('#C5F8C8', '#FAF096', '#FCCB8F', '#F9989F'),
    ('#EFDFBF', '#FFC0D0', '#FFE0E0', '#FFFAFA'),
    ('#EF5A5A', '#FFA952', '#FFE79A', '#FEFFDF'),
    ('#DFBAF7', '#FFE6CC', '#ECFFC1', '#B8FFD0'),
    ('#FFF8A1', '#FF008B', '#FAF7E6', '#73DBC4'),
    ('#228C7B', '#F6C523', '#F6F3A7', '#F30E5C'),
    ('#CC99F9', '#DEC8ED', '#F5FAC7', '#89F8CE'),
    ('#EEF5DB', '#C7EFCF', '#FE5F55', '#FFEAA5'),
    ('#D7F8F7', '#BEE4D2', '#FAB2AC', '#EDA1C1'),
    ('#F0F3F3', '#CEECF0', '#FF7777', '#F9FA9B'),
    ('#99DDCC', '#F6F6F6', '#FFE2E2', '#BAD7DF'),
    ('#FFAAA5', '#FFD3B6', '#FDFFAB', '#A8E6CF'),
    ('#571179', '#08C299', '#97DE95', '#FCE8AA'),
    ('#952E4B', '#FF5D5D', '#FBE4C9', '#84B9EF'),
    ...
    ('#FBFAE1', '#F1EFB9', '#04DEAD', '#0E9577'),
    ('#F5E9FF', '#FCFFBF', '#FFF195', '#FF7777'),
    ('#7CBD1E', '#BCEB3C', '#F1F864', '#FCF9F9'),
    ('#FF4273', '#FF9D76', '#FFFDE1', '#1FFFFF'),
    ('#E46161', '#F1B963', '#F8F398', '#CBF078'),
    ('#FCFFC8', '#D5FFFB', '#7CDFFF', '#E9007F'),
    ('#FCEA90', '#56A7A7', '#A0DBDB', '#F9FBFC'),
    ('#EF255F', '#FCCF4D', '#49BEB7', '#085F63'),
    ('#2E89BA', '#A5BFDD', '#F9F6D8', '#F60C86'),
    ('#CABBE9', '#FFCEF3', '#FDFDFD', '#A1EAFB'),
    ('#FFEBEB', '#FF8585', '#FF5757', '#FF007B'),
    ('#FF5D6E', '#2EB872', '#A3DE83', '#FEFFEA'),
    ('#E8B844', '#F5D97E', '#FEF2F2', '#F03861'),
    ('#A6ED8E', '#28CC9E', '#E3F8FF', '#FFDD83'),
    ('#FFB174', '#EE5A5A', '#B31E6F', '#22EAAA'),
    ...
    ('#F60C86', '#FFF6A2', '#9FEED1', '#11CBD7'),
    ('#FBD0F5', '#F7F680', '#94F6F2', '#D7AEF3'),
    ('#295BA7', '#94AC3C', '#FCC314', '#EEEEEE'),
    ('#F6FCAE', '#D89FFF', '#C7F5FF', '#FFABE5'),
    ('#F6318C', '#FFF2BE', '#A0EECC', '#36D1C4'),
    ('#F6CA97', '#FB9696', '#EA2BA2', '#BE0EAA'),
    ('#8EA5EB', '#F5EFE8', '#FFDD00', '#F6378F'),
    ('#7BC7FA', '#76E3FF', '#FBFF64', '#FF8FE5'),
    ('#FDFFE7', '#C9FDD7', '#99F0CA', '#8C7676'),
    ('#FCD78E', '#F9F296', '#41EECB', '#20DECB'),
    ('#A31C88', '#BB47BE', '#F08EDB', '#FDF196'),
    ('#C9F0D6', '#F2FFDF', '#FFEC85', '#FFCA61'),
    ('#FA7F7F', '#F8FBA2', '#A0E4B0', '#C2FCD9'),
    ('#F9FCC9', '#E889E5', '#D17AE5', '#BAF5F0'),
    ...
    ('#D86EFF', '#FF8AB4', '#FFD6A6', '#FBFFE0'),
    ('#FCFFC1', '#FF917B', '#F469A9', '#65EAD1'),
    ('#568564', '#FFF3A7', '#FF858A', '#F72464'),
    ('#A2E4A2', '#A980E4', '#F59AF0', '#FDFFA3'),
    ('#FD7E89', '#FFF798', '#F4E3B7', '#89AA97'),
    ('#A73CCB', '#E85395', '#FF9071', '#FFF5B5'),
    ('#FF98DA', '#D6EC78', '#EFFFB7', '#27E1CE'),
    ('#1BB5EC', '#4DF4FF', '#F7FED4', '#FF5AB0'),
    ('#95E1D3', '#EAFFD0', '#FCE38A', '#F38181'),
    ('#F1D665', '#F3FFA1', '#83F084', '#59B791')
]
...
happy_colors_4 = [
    ...
    ('#BAFFB4', '#FFFDA2', '#FFAB76', '#FF6363'),
    ('#FFCBCB', '#E7FBBE', '#FFFDDE', '#D9D7F1'),
    ('#FFF5E1', '#FFD39A', '#9A0680', '#781C68'),
    ('#1A5F7A', '#086E7D', '#FFC900', '#FFF89A'),
    ('#8843F2', '#EF2F88', '#F47340', '#F9D371'),
    ('#06FF00', '#FFE400', '#FF8E00', '#FF1700'),
    ('#516BEB', '#84DFFF', '#FFFCDC', '#EDD2F3'),
    ('#FF9999', '#FFEBCC', '#FBFFE2', '#FFAFAF'),
    ...
    ('#FFEDED', '#FDB9FC', '#ED50F1', '#FF00E4'),
    ('#FFFEB7', '#FFEFBC', '#FFDAC7', '#FFADAD'),
    ('#E05D5D', '#FFB344', '#FFF8E5', '#00A19D'),
    ('#FD6F96', '#FFEBA1', '#95DAC1', '#6F69AC'),
    ('#B8DFD8', '#E8F6EF', '#FFE194', '#FFB319'),
    ('#FF2442', '#FFB830', '#FFEDDA', '#3DB2FF'),
    ('#DF2E2E', '#F6D167', '#FFF7AE', '#297F87'),
    ('#F2BB7B', '#FFDFAF', '#FDF5CA', '#FFDEDE'),
    ('#C2F784', '#FFF47D', '#FFBF86', '#F6A9A9'),
    ('#9DDAC6', '#C2FFD9', '#FFD371', '#FF4848'),
    ('#DF711B', '#FFB740', '#FDE49C', '#64C9CF'),
    ...
    ('#F0C9C9', '#F1F0CF', '#B6E6BD', '#4BAEA0'),
    ('#E5D429', '#A0C334', '#5D5D5D', '#F7F7F7'),
    ('#7ECFC0', '#F2E3C9', '#EF4B4B', '#FA5477'),
    ('#FF502F', '#49BEB7', '#32DBC6', '#EBEFD0'),
    ('#83B582', '#D6E4AA', '#FFFFC5', '#F0DD92'),
    ('#F34573', '#226B80', '#35B0AB', '#C5F0A4'),
    ('#EDAAAA', '#EBCE95', '#ECEBA7', '#9CF196'),
    ('#EF4B4B', '#EC8F6A', '#F2E3C9', '#7ECFC0'),
    ('#FFEECF', '#F5C181', '#00A79D', '#007065'),
    ('#AB72C0', '#CBA1D2', '#FDEAAB', '#FFFCC1'),
    ...
    ('#27AA80', '#32FF6A', '#A8FF3E', '#F4FF61'),
    ('#FDDEDE', '#F5FEC0', '#CAF2D7', '#60A9A6'),
    ('#39BDC8', '#59D4E8', '#CAA5F1', '#FAC0E1'),
    ('#248EA9', '#28C3D4', '#AEE7E8', '#FAFDCB'),
    ('#112F91', '#1B7FBD', '#23EAE6', '#F6EF98'),
    ('#B96B9F', '#E2BEBE', '#FCFDD8', '#F5F687'),
    ('#032D3C', '#4BE3AC', '#94FC13', '#F7FF56'),
    ('#FF9E74', '#EE5A5A', '#B31E6F', '#22EACA'),
    ('#D8EFF0', '#B0E0A8', '#F0F69F', '#F3C1C6'),
    ...
    ('#FFD581', '#BF81FF', '#837DFF', '#6927FF'),
    ('#C5F8C8', '#FAF096', '#FCCB8F', '#F9989F'),
    ('#F2EFB6', '#A0EDF7', '#0EA5C6', '#074684'),
    ('#FFFA67', '#FFCD60', '#FF8162', '#D34848'),
    ('#F2F2F2', '#B9E6D3', '#7ED3B2', '#EF6C57'),
    ('#FCF2DB', '#FFC5E6', '#DCAEE8', '#6EFFBF'),
    ('#6D70C6', '#96DAE4', '#CDEEAA', '#FFEDC6'),
    ('#FFECD3', '#FFB0FE', '#FF6BD6', '#1B335F'),
    ...
    ('#EEC60A', '#F07810', '#C50D66', '#F5F4E8'),
    ('#1D97C1', '#53C7F0', '#87E0FF', '#FFFFE3'),
    ('#53D397', '#F7F9FF', '#FF7A5C', '#D1478C'),
    ('#EEF5DB', '#C7EFCF', '#FE5F55', '#FFEAA5'),
    ('#F9F7F7', '#60EFB8', '#CEFC86', '#90AEFF'),
    ('#446E5C', '#6A9C78', '#7DC383', '#FFF1BC'),
    ('#F65454', '#F97272', '#FADC6D', '#F6EC66'),
    ('#FFE981', '#65DAF7', '#75C2F6', '#448EF6'),
    ('#FFE8D5', '#FDB87D', '#FF8364', '#FF4D4D'),
    ('#FEF4A9', '#3B9A9C', '#4BC2C5', '#78FEE0'),
    ('#79BD8F', '#BEEB9F', '#FFFF9D', '#FF6138'),
    ...
    ('#F60C86', '#FFF6A2', '#9FEED1', '#11CBD7'),
    ('#FF7575', '#F08E6B', '#FFB270', '#F6FEA1'),
    ('#FEF3CC', '#FCCF4D', '#2DB6A3', '#22C7A9'),
    ('#F677F7', '#EFA7F3', '#FACBF8', '#F8FDC3'),
    ('#FAF15D', '#0AA0F6', '#0E7CF4', '#0962EA'),
    ('#F56262', '#FCA180', '#FFD480', '#FFFE9F'),
    ('#F3F798', '#EAB4F8', '#FCC8F8', '#C7F5FE'),
    ('#FFE869', '#FFFBCB', '#ED5485', '#57D1C9'),
    ('#FFE4B3', '#9DD3CC', '#FA8383', '#CA3E6B'),
    ('#8EA1F0', '#82C7EB', '#A5F0E4', '#F5FAC8'),
    ('#482FF7', '#2D6CDF', '#46C3DB', '#F3F169'),
    ('#F6318C', '#FFF2BE', '#A0EECC', '#36D1C4'),
    ('#F6CA97', '#FB9696', '#EA2BA2', '#BE0EAA'),
    ('#C0FFC2', '#FDFFBA', '#FFEAB6', '#F69D9D'),
    ('#FF7E67', '#FAFAFA', '#A2D5F2', '#07689F'),
    ('#9EFCB4', '#F5FC9E', '#FDDD8A', '#FD9191'),
    ('#FFF59D', '#DCE775', '#8BC34A', '#388E3C'),
    ('#342B2B', '#459D72', '#90D26D', '#DEFBC2'),
    ('#9E7E44', '#E3CE8B', '#F9F5CE', '#FFA0C2'),
    ('#0A4650', '#2C9E4B', '#9ED763', '#FFF2B2'),
    ('#FDFDCB', '#F4AEBA', '#EC729C', '#C54C82'),
    ('#70A1D7', '#A1DE93', '#F7F48B', '#F47C7C'),
    ('#95E1D3', '#D6F7AD', '#FCE38A', '#F38181'),
    ('#FFFCBF', '#1FDEDB', '#317AE1', '#1333A6'),
    ('#C9F0D6', '#F2FFDF', '#FFEC85', '#FFCA61'),
    ...
    ('#CC3D0B', '#E3670C', '#FBB448', '#FFEEE7'),
    ('#BA52ED', '#FF99FE', '#A4F6F9', '#E4FFFE'),
    ('#FBFFA3', '#C6E872', '#66D37E', '#083836'),
    ('#F0FC93', '#7AB7FF', '#828BFF', '#6251DA'),
    ('#D86EFF', '#FF8AB4', '#FFD6A6', '#FBFFE0'),
    ('#78D8D0', '#A1F6B6', '#FAF99F', '#D65F5F'),
    ('#84E9FF', '#C244FB', '#FFA1D0', '#FFF9C1'),
    ('#42CFC4', '#CD0A0A', '#FF5656', '#FFFBAF'),
    ('#5CA4CA', '#74D2FF', '#E0FFF9', '#FCF798'),
    ('#FCFFC1', '#FF917B', '#F469A9', '#65EAD1'),
    ('#F0E48E', '#FD89DD', '#BF68F6', '#B8EEF1'),
    ('#568564', '#FFF3A7', '#FF858A', '#F72464'),
    ...
    ('#A1F480', '#3DBDC2', '#0C9CEE', '#591FCE'),
    ('#A73CCB', '#E85395', '#FF9071', '#FFF5B5'),
    ('#FFF079', '#FFD48B', '#FF80F3', '#9A47CB'),
    ('#FF2865', '#FF639F', '#FFB26B', '#FFF29C'),
    ('#7899DC', '#0FEFBD', '#FEFF92', '#CFF800'),
    ('#8FF5D2', '#FCFFC9', '#FAF885', '#F79486'),
    ('#0D625E', '#66D37E', '#C6E872', '#FBFFA3'),
    ('#B64926', '#FFB03B', '#FFF0A5', '#468966'),
    ('#346357', '#1DAD9B', '#9BF4D5', '#FCFFC1'),
    ('#FDE9C9', '#FCC29A', '#13829B', '#29D2E4'),
    ('#EE7CFF', '#FC92E3', '#FED96B', '#FEFEA4'),
    ('#F96B85', '#FFD478', '#FFFD88', '#B2E672'),
    ('#F4FA9C', '#F469A9', '#BA53DE', '#88BEF5'),
    ('#44FADD', '#B767FF', '#534C98', '#FFEE7D'),
    ('#FF165D', '#FF9A00', '#F6F7D7', '#3EC1D3'),
    ('#AABBFF', '#F9FFA5', '#FFB072', '#FF5A5A'),
    ('#E8FFC1', '#9EF5CF', '#51DACF', '#0278AE'),
    ('#63F5EF', '#41B3FF', '#7459DC', '#FFF395'),
    ('#1BB5EC', '#4DF4FF', '#F7FED4', '#FF5AB0'),
    ('#C6394D', '#FF6B83', '#FFB576', '#FEFFCB'),
    ('#F6B132', '#C7F6F5', '#A0E4E0', '#37B7B5'),
    ('#44FADD', '#534C98', '#B767FF', '#FFEE7D'),
    ('#FFDE7D', '#F6416C', '#F8F3D4', '#00B8A9'),
    ('#F7F7CF', '#C1D343', '#FF6600', '#990000'),
    ('#BCFFF2', '#83D9EF', '#AD64C5', '#FEFF94'),
    ('#FFADED', '#C768FF', '#7045FF', '#83FFE1'),
    ('#FF89C0', '#E3FFC3', '#6DF1CC', '#2FC5CC'),
    ('#F1F3B8', '#96EAB7', '#53CDD8', '#7B99FA'),
    ('#95E1D3', '#EAFFD0', '#FCE38A', '#F38181'),
    ('#FCFF88', '#F9CC6A', '#942E88', '#DB5CA6'),
    ('#F1D665', '#F3FFA1', '#83F084', '#59B791'),
    ('#BCFFF2', '#88D8EC', '#AD64C5', '#FEFF94'),
    ('#FCED25', '#B0D553', '#63B75D', '#217756'),
    ('#F3F74D', '#F6E97F', '#E09EE8', '#B074E9'),
    ('#80D6FF', '#EDF798', '#FAB57A', '#F06868'),
    ('#FFCF5E', '#F2FF97', '#9ED79A', '#068B78'),
    ('#FFFF9D', '#BEEB9F', '#79BD8F', '#00A388'),
    ('#DAFA8B', '#F85ACA', '#6341B4', '#442D7C'),
    ('#FFCB3C', '#FEED30', '#B3E55E', '#51AF5B'),
    ('#5BE7A9', '#F8FE85', '#FFBD67', '#FF6464'),
    ('#6EAFF7', '#29668B', '#4BC87F', '#F0F87F'),
    ('#A1D76F', '#E8FD96', '#EDA489', '#D15555'),
]


# NATURE 
nature_colors_4 = [
    ('#A0937D', '#F3FF90', '#9BEC00', '#06D001'),
    ...
    ('#D55252', '#E47312', '#94AA2A', '#E5D8BF'),
    ('#FDECED', '#EFCFB6', '#6B591D', '#233714'),
    ('#FF7E67', '#35495E', '#347474', '#42B883'),
    ('#FAE8C8', '#C9D99E', '#FDA77F', '#445C3C'),
    ('#F0C9C9', '#F1F0CF', '#B6E6BD', '#4BAEA0'),
    ('#FFFFEA', '#EAEBD8', '#E6A400', '#91B029'),
    ('#83B582', '#D6E4AA', '#FFFFC5', '#F0DD92'),
    ('#DA4302', '#A0CC78', '#589167', '#207561'),
    ('#672F2F', '#99B19C', '#D7D1C9', '#FAF5EF'),
    ('#FDDEDE', '#F5FEC0', '#CAF2D7', '#60A9A6'),
    ('#2B580C', '#AFA939', '#F7B71D', '#FDEF96'),
    ('#D9D872', '#58B368', '#009975', '#454D66'),
    ('#FFFFB5', '#7BC67B', '#6B8C42', '#5A3921'),
    ('#F8EEB4', '#A7D129', '#616F39', '#1B1919'),
    ('#F7FFBD', '#B5E0BA', '#905858', '#5D3A3A'),
    ...
    ('#F8D0B0', '#78B0A0', '#709078', '#587850'),
    ('#5C8D89', '#74B49B', '#A7D7C5', '#F9F8EB'),
    ('#0F117A', '#389168', '#12E2A3', '#DDF516'),
    ('#FFCAB0', '#FFEBBB', '#FDFFCD', '#E0FFCD'),
    ('#EAE7E7', '#F9F8EB', '#76B39D', '#155E63'),
    ('#FFCDB5', '#A1C45A', '#FFE5AB', '#FFF6F6'),
    ('#FF5C00', '#2E5A1C', '#4E9525', '#EDF0C7'),
    ('#27253D', '#326765', '#7DA87B', '#F5F5C6'),
    ('#FFF1BC', '#6A9C78', '#C4E3CB', '#F9F8ED'),
    ('#F8EEB4', '#CFEE91', '#658525', '#092A35'),
    ('#446E5C', '#6A9C78', '#7DC383', '#FFF1BC'),
    ('#1A3C40', '#144D53', '#307672', '#E4EDDB'),
    ('#D95858', '#BDCF88', '#D9F489', '#EDFEAD'),
    ('#FFA06F', '#FFD6A0', '#ACBD86', '#28544B'),
    ('#7E6752', '#61B292', '#AED09E', '#F4EEC0'),
    ('#4F323B', '#6BA083', '#BCFFA8', '#F6FFCD'),
    ('#FFDD5C', '#76A665', '#227066', '#265961'),
    ('#DE561C', '#FDA831', '#F4D143', '#D0EF84'),
    ('#F8F1D0', '#EAC100', '#0B8457', '#096C47'),
    ('#F7F39A', '#A3DE83', '#239D60', '#212125'),
    ('#476269', '#40A798', '#F1F1F1', '#F5E1DA'),
    ('#092A35', '#658525', '#CFEE91', '#F8EEB4'),
    ('#ECEFD8', '#EED690', '#849561', '#393939'),
    ('#709053', '#81AE64', '#C7E78B', '#FFF4C9'),
    ('#F2FECA', '#BCFCC9', '#98D083', '#4A3333'),
    ('#F1FFF1', '#C4F0C5', '#935656', '#6A0000'),
    ('#FF5D6E', '#2EB872', '#A3DE83', '#FEFFEA'),
    ('#DDEEDF', '#8BC34A', '#388E3C', '#F2F9F1'),
    ('#525050', '#7FB414', '#A0E418', '#E5F9BD'),
    ('#B1AD25', '#DAD773', '#F0EEB1', '#FDFCE0'),
    ('#E0E7F1', '#AEBD77', '#538F6A', '#1B4B36'),
    ('#F7FFCD', '#BADF96', '#693E52', '#1C1124'),
    ('#D9BF77', '#D8EBB5', '#639A67', '#205D67'),
    ('#ECF3F6', '#EAB64D', '#127C56', '#3D262A'),
    ('#83B271', '#ABCB89', '#D2EA9B', '#E7F0D2'),
    ('#E9EAB4', '#D6D88B', '#B7B56E', '#428B46'),
    ('#5C8D89', '#74B49B', '#A7D7C5', '#D3F6D1'),
    ('#EDE9A3', '#D7C37A', '#55A44E', '#1B8057'),
    ('#F3FFB9', '#A6ED8E', '#1AA59A', '#1B5A7A'),
    ('#F7BE7F', '#D1EBFE', '#4ED99C', '#2AAF74'),
    ('#303E27', '#B4BB72', '#E7EAA8', '#F6FAF7'),
    ('#D7FBE8', '#9DF3C4', '#62D2A2', '#1FAB89'),
    ('#535A3B', '#A7B99E', '#CEDCC3', '#EFF7D3'),
    ('#F9DE79', '#F8FAE4', '#D0DD97', '#658361'),
    ('#FFF59D', '#DCE775', '#8BC34A', '#388E3C'),
    ('#FDFFE7', '#C9FDD7', '#99F0CA', '#8C7676'),
    ('#342B2B', '#459D72', '#90D26D', '#DEFBC2'),
    ('#0A4650', '#2C9E4B', '#9ED763', '#FFF2B2'),
    ('#01352C', '#61B390', '#BAD8B6', '#E1EACD'),
    ('#F2F299', '#C8E29D', '#5E9387', '#58828B'),
    ('#2B3752', '#2E6E65', '#86EE60', '#F4F7ED'),
    ('#FFF8B5', '#B5FF7D', '#52D681', '#00AD7C'),
    ('#DFF09D', '#D5D46F', '#1C4648', '#295E62'),
    ('#2EB872', '#A3DE83', '#FEFFE4', '#FA4659'),
    ('#424242', '#51710A', '#C5D200', '#F5F5F5'),
    ('#9D4545', '#77B5A6', '#ACE6C0', '#D7FFDF'),
    ('#FBFFA3', '#C6E872', '#66D37E', '#083836'),
    ('#346473', '#25A55F', '#9BDF46', '#EAEFC4'),
    ('#3B5B5D', '#547C66', '#ACDB86', '#FEFFA0'),
    ('#99CDA9', '#D1E9D2', '#E5F4E7', '#F1FDF3'),
    ('#F0F0F0', '#9DDA52', '#2EAC6D', '#3C2F3D'),
    ('#202E24', '#347A2A', '#B3C87A', '#EBE8BE'),
    ('#94ED88', '#3BB873', '#406661', '#384137'),
    ('#A8896C', '#F1E8A7', '#AED09E', '#61B292'),
    ('#E4F4FD', '#FCC72C', '#4CB648', '#083C5A'),
    ('#F8D098', '#098B54', '#067242', '#003E21'),
    ('#0D625E', '#66D37E', '#C6E872', '#FBFFA3'),
    ('#483D3C', '#A97555', '#A7CF5D', '#F9EBC4'),
    ('#444036', '#686354', '#50C19A', '#E4F68F'),
    ('#424141', '#21825C', '#A4D792', '#F7FDB6'),
    ('#C5F5C2', '#98E19A', '#66A96B', '#3B5F41'),
    ('#FCED25', '#B0D553', '#63B75D', '#217756'),
    ('#CBE0E0', '#61B136', '#BBDC2F', '#2C5460'),
    ('#955A47', '#B1BD5D', '#EDD690', '#F0F0EF'),
    ('#3F84AC', '#32C38C', '#85EB4E', '#F4F787'),
    ('#FFCB3C', '#FEED30', '#B3E55E', '#51AF5B'),
    ('#336371', '#93AF56', '#F0D587', '#F3F2C9'),
    ('#DDDB6A', '#F7FFA3', '#B3E55E', '#51AF5B'),
    ('#E5DD90', '#BDBE36', '#678C40', '#335C49')
]

# EARTH
earth_colors_4 = [
    ('#254336', '#FED8B1', '#ECB176', '#A67B5B'),
    ('#F1F1F1', '#C7B7A3', '#EADBC8', '#B5C18E'),
    ('#B99470', '#DEAC80', '#F7DCB9', '#B5C18E'),
    ('#AFD198', '#E8EFCF', '#ECCA9C', '#DBA979'),
    ('#9CAFAA', '#D6DAC8', '#FBF3D5', '#EFBC9B'),
    ...
    ('#6E7DA2', '#DB996C', '#AEDADD', '#FCF8F3'),
    ('#5C8D89', '#74B49B', '#A7D7C5', '#F9F8EB'),
    ('#E8EAA1', '#80AC7B', '#605A56', '#373331'),
    ('#A6AA9C', '#F7D3BA', '#E6E7E5', '#F5EFE3'),
    ('#DBD7CB', '#F2F3EE', '#B1D1C5', '#CB9B42'),
    ('#596E79', '#C7B198', '#DFD3C3', '#F0ECE2'),
    ('#00541A', '#935900', '#CE7D00', '#FEF9D9'),
    ('#C9FFC7', '#6DDABE', '#4BBB8B', '#535238'),
    ('#616161', '#8AAE92', '#C4E3CB', '#F4F9F4'),
    ('#42291C', '#3F5468', '#B8E4C9', '#E9FADD'),
    ('#FDC57B', '#FBF2D5', '#7FA99B', '#394A51'),
    ('#7E6752', '#61B292', '#AED09E', '#F4EEC0'),
    ('#557669', '#669B7C', '#EBEBEB', '#F2D1A8'),
    ('#F4E5C2', '#6DB193', '#295F4E', '#323232'),
    ('#ECEFD8', '#EED690', '#849561', '#393939'),
    ('#403F48', '#596C68', '#95A792', '#E3D9CA'),
    ('#8F8787', '#EBCBAE', '#F9F9F9', '#A6E4E7'),
    ('#8C7676', '#FDFFE7', '#C9FDD7', '#99F0CA'),
    ('#E1D5D2', '#E79A58', '#A55540', '#4B4A5A'),
    ('#ECF3F6', '#EAB64D', '#127C56', '#3D262A'),
    ('#796465', '#CB8589', '#E8D2AE', '#DDE8B9'),
    ('#DDDDBB', '#779977', '#447878', '#4B2C34'),
    ('#535A3B', '#A7B99E', '#CEDCC3', '#EFF7D3'),
    ('#FDFFE7', '#C9FDD7', '#99F0CA', '#8C7676'),
    ('#E6D3A7', '#59A985', '#3A7563', '#392F2F'),
    ('#52575D', '#41444B', '#DFD8C8', '#CABFAB'),
    ...
    ('#B3A78C', '#F6E7C1', '#F4722B', '#3E3E3E'),
    ('#483D3C', '#A97555', '#A7CF5D', '#F9EBC4'),
    ('#E5F6C6', '#ABD4C1', '#7E858B', '#5D414D'),
    ('#533710', '#6E4B1F', '#98651E', '#F0D394'),
    ('#FCC0C0', '#CD9D77', '#B2704E', '#894949'),
    ('#D3A284', '#E5E5E5', '#58727F', '#83AFA6'),
    ('#D9B26E', '#9C563D', '#654534', '#3D322C'),
    ('#B89068', '#F7DDA4', '#464D5C', '#567582')
]
...
night_colors_4 = [
    ...
    ('#A4B494', '#519872', '#3B5249', '#382933'),
    ('#87556F', '#59405C', '#322F3D', '#4B5D67'),
    ('#EBEBEB', '#050505', '#221F3B', '#6F4A8E'),
    ('#E1FFC2', '#C7E2B2', '#89C9B8', '#092532'),
    ('#FF4301', '#FA7D09', '#4A3F35', '#2F2519'),
    ('#204051', '#3B6978', '#84A9AC', '#E7DFD5'),
    ('#07031A', '#4F8A8B', '#B1B493', '#FFCB74'),
    ...
    ('#ECECEC', '#C1A57B', '#30475E', '#222831'),
    ('#ECECEC', '#F2A365', '#30475E', '#222831'),
    ('#D8B9C3', '#827397', '#4D4C7D', '#363062'),
    ('#CAE8D5', '#84A9AC', '#3B6978', '#204051'),
    ('#EAB9C9', '#AD62AA', '#4A47A3', '#413C69'),
    ('#00A8CC', '#0C7B93', '#27496D', '#142850'),
    ('#F5EAEA', '#7FCD91', '#5B5656', '#4D4646'),
    ('#BBE1FA', '#3282B8', '#0F4C75', '#1B262C'),
    ('#F5CDAA', '#CFB495', '#758184', '#5D5B6A'),
    ...
    ('#F638DC', '#5A3D5C', '#382039', '#200F21'),
    ('#F9D276', '#AD1D45', '#83142C', '#44000D'),
    ('#FF6768', '#6B778D', '#263859', '#17223B'),
    ('#CA3E47', '#313131', '#414141', '#525252'),
    ('#8F758E', '#735372', '#313848', '#8ADFDC'),
    ('#EEEEEE', '#D65A31', '#393E46', '#222831'),
    ('#00334E', '#145374', '#5588A3', '#E8E8E8'),
    ('#DAE1E7', '#DD6B4D', '#1C4B82', '#183661'),
    ('#000000', '#226089', '#4592AF', '#E3C4A8'),
    ('#FDC57B', '#007880', '#62374E', '#33313B'),
    ('#FFD700', '#115173', '#053F5E', '#022C43'),
    ('#F6E5E5', '#E6B2C6', '#774181', '#352961'),
    ('#F7B633', '#5893D4', '#1F3C88', '#070D59'),
    ('#E9EEC9', '#BBBBBB', '#913535', '#283148'),
    ('#FDB44B', '#448EF6', '#005792', '#00204A'),
    ('#E6F5FF', '#834C69', '#3C4F65', '#33313B'),
    ...
    ('#0B0B0D', '#474A56', '#929AAB', '#D3D5FD'),
    ('#EFECEC', '#62929A', '#5C5757', '#363434'),
    ('#EAE3E3', '#DD7777', '#20366B', '#2D095C'),
    ('#F67280', '#C06C84', '#6C5B7B', '#35477D'),
    ('#DBEDF3', '#00818A', '#404B69', '#283149'),
    ('#B7E1B5', '#DE774E', '#684656', '#1C1124'),
    ('#A7D7C5', '#74B49B', '#693E52', '#1C1124'),
    ('#FCFA70', '#6A99CB', '#4D7CAE', '#375A7F'),
    ('#F1D18A', '#4C6F7B', '#255965', '#032A33'),
    ('#ED8D8D', '#8D6262', '#4D4545', '#393232'),
    ('#FF6C00', '#A0204C', '#23103A', '#282D4F'),
    ('#FFD8D8', '#E99B9B', '#50595C', '#302939'),
    ('#F7B633', '#90A4AE', '#607D8B', '#37474F'),
    ('#3F7B70', '#265A5C', '#113C4A', '#DDDDDD'),
    ('#F6E9E9', '#E16428', '#272121', '#363333'),
    ('#F1BBD5', '#A12559', '#5F1854', '#3B0944'),
    ('#272637', '#474168', '#626F92', '#F9C4AC'),
    ('#EAE1E1', '#978D58', '#03051E', '#0B5269'),
    ('#FFDED5', '#ACBDC5', '#52686A', '#314A52'),
    ('#EEEEEE', '#E4DCAD', '#181810', '#062121'),
    ('#E4E4E4', '#044343', '#045757', '#222222'),
    ('#77ABB7', '#476D7C', '#254B62', '#1D3E53'),
    ('#F7F7F7', '#F6C90E', '#2E4750', '#303841'),
    ('#EDEDED', '#68868C', '#405559', '#3E3E3E'),
    ('#BE3144', '#303841', '#3A4750', '#D3D6DB'),
    ('#EEEEEE', '#0092CA', '#393E46', '#222831'),
    ('#F9F2D7', '#F2DEA8', '#21294C', '#141829'),
    ...
    ('#F59D2A', '#EE7738', '#2C3D4F', '#34495D'),
    ('#E7E8F5', '#70A3C4', '#1F6CB0', '#4E4E6A'),
    ('#FF7844', '#A64942', '#53354A', '#1B1F3A'),
    ('#65C6C4', '#408AB4', '#34699A', '#113F67'),
    ('#E0E7E9', '#A3C6C4', '#6C7A89', '#354649'),
    ('#EEEEEE', '#EA9215', '#3A4750', '#303841'),
    ('#FC85AE', '#9E579D', '#574B90', '#303A52'),
    ('#0DE2EA', '#0F81C7', '#06648C', '#015668'),
    ('#EDE68A', '#B0A565', '#383A56', '#2F3032'),
    ('#17B794', '#28518A', '#22267B', '#01005E'),
    ('#E8E8E8', '#5588A3', '#145374', '#00334E'),
    ('#FFC12D', '#65589C', '#544D7E', '#43496E'),
    ('#EEEEEE', '#D72323', '#3A4750', '#303841'),
    ('#B9EAF5', '#7DBCC8', '#6D739D', '#6F4F8B'),
    ('#E47676', '#8F1383', '#45056E', '#1F024C'),
    ('#00EAFF', '#1F8EA3', '#284184', '#020438'),
    ('#EEEEEE', '#393E46', '#222831', '#7BC74D'),
    ('#311D3F', '#522546', '#88304E', '#E23E57'),
    ('#D7C1E0', '#876A96', '#584F84', '#38486F'),
    ('#84C69B', '#2F8886', '#28475C', '#1A2F4B'),
    ('#D1D4C9', '#556E53', '#29435C', '#152A38'),
    ('#F0E3E3', '#748B9C', '#2F576E', '#433751'),
    ('#E4E5DB', '#D6CFB9', '#2F5241', '#152A38'),
    ('#2A2438', '#352F44', '#5C5470', '#DBD8E3'),
    ('#E9B5D2', '#951556', '#561050', '#35013F'),
    ('#E1F6F4', '#7DB9B3', '#166678', '#2E3837'),
    ('#C94E4E', '#713045', '#582233', '#430D27'),
    ('#310A5D', '#411E8F', '#2A2438', '#352F44'),
    ('#DE703C', '#FBB040', '#506F86', '#2F3C4F'),
    ('#25161B', '#453953', '#975A5E', '#F3CBA5'),
    ('#FFD717', '#0D63A5', '#083358', '#001F3F'),
